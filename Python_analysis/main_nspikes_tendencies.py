...
for P1 in P:
    ...
    data_means[r"$#_{spikes}\,AB$"].append(np.mean(intervaloAB))
    data_means[r"$#_{spikes}\,PD1$"].append(np.mean(intervaloPD1))
    data_means[r"$#_{spikes}\,PD2$"].append(np.mean(intervaloPD2))
    data_means[r"$#_{spikes}\,LP$"].append(np.mean(intervaloLP))
    data_means[r"$#_{spikes}\,PY$"].append(np.mean(intervaloPY))
    data_stds[r"$#_{spikes}\,AB$"].append(np.std(intervaloAB))
    data_stds[r"$#_{spikes}\,PD1$"].append(np.std(intervaloPD1))
    data_stds[r"$#_{spikes}\,PD2$"].append(np.std(intervaloPD2))
    data_stds[r"$#_{spikes}\,LP$"].append(np.std(intervaloLP))
    data_stds[r"$#_{spikes}\,PY$"].append(np.std(intervaloPY))
