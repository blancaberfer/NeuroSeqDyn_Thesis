...
void kk_model(double tiempo, double *x, double *fvec) {
    ...
    fvec[Vm_Y] =
        -(INaTTX_Y + IKTEA_Y + IK_Y + INa_Y + INaV_Y + IB_Y + ICa_Y + ICa_Ca_Y + I_f_XY) / Cm;
    ...
    fvec[Vm_Z] =
        -(INaTTX_Z + IKTEA_Z + IK_Z + INa_Z + INaV_Z + IB_Z + ICa_Z + ICa_Ca_Z + I_elec_XZ) / Cm;
