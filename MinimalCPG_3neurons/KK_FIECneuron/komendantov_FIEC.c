...
void kk_model(double tiempo, double * x,double * fvec)
{
	...
	fvec[Vm_X] = - (INaTTX_X + IKTEA_X + IK_X + INa_X + INaV_X + IB_X + ICa_X + ICa_Ca_X + I_s_YX)/ Cm; // + I_elec_Z1X
	...
	fvec[Vm_Y] = - (INaTTX_Y + IKTEA_Y + IK_Y + INa_Y + INaV_Y + IB_Y + ICa_Y + ICa_Ca_Y + I_f_XY + I_elec_ZY) / Cm; // 
	...
	fvec[Vm_Z] = - (INaTTX_Z + IKTEA_Z + IK_Z + INa_Z + INaV_Z + IB_Z + ICa_Z + ICa_Ca_Z + I_elec_YZ) / Cm;
